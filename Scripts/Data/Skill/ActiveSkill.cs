...
{
    public ActiveSkill(int _skillKey, string _skillName, int _skillLevel, int _skillType, int _skillVarable, int _skillValue1, int _skillValue2, int _skillValue3, int _skillValue4, int _skillValue5, int _skillValue6, int _skillValue7, int _skillValue8, int _skillValue9, int _skillValue10, float _skillFigures1, float _skillFigures2, float _skillFigures3, float _skillFigures4, float _skillFigures5, float _skillFigures6, float _skillFigures7, float _skillFigures8, float _skillFigures9, float _skillFigures10, float _coolTime, int _skillHitCount) 
