...
{
    public Spear(int _itemKey, string _itemName, string _itemKorName, int _buyPrice, int _sellPrice, string _attackType, string _weaponType,
 ...
 : base(_itemKey, _itemName, _itemKorName, _buyPrice, _sellPrice, _attackType, _weaponType, _physicalDamage, _magicalDamage, _atkRange, _atkDistance, _atkSpeed, _equipLevel, _disassembleItemKey, _disassembleItemAmount, _itemRank)
    {
        singleSprite = Resources.Load("Sprites/10_Spear/" + itemName, typeof(Sprite)) as Sprite;
        texture2D = Resources.Load("Sprites/10_Spear/" + itemName, typeof(Texture2D)) as Texture2D;
