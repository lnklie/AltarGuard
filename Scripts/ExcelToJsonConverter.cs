...
public class ExcelToJsonConverter
{
	...
	public static event ConversionToJsonSuccessfullHandler ConversionToJsonSuccessfull = delegate { };

	public delegate void ConversionToJsonFailedHandler();
	public static event ConversionToJsonFailedHandler ConversionToJsonFailed = delegate { };
	...
	public static void ConvertExcelFilesToJson(string inputPath, string outputPath, bool recentlyModifiedOnly = false)
	{
	...
	/// <param name="outputPath">Output path.</param>
	public static bool ConvertExcelFileToJson(string filePath, string outputPath)
	{
	...
	private static DataTable GetExcelSheetData(IExcelDataReader excelReader)
	{
		if (excelReader == null)
		{
	...
	/// <param name="filePath">File path.</param>
	private static List<string> GetSheetNamesInFile(string filePath)
	{
